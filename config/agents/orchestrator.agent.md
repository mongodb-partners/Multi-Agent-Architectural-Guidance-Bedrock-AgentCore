...
6. If the user asks a simple profile-memory question (for example "what color do I like?", "what did I tell you about my preferences?") and relevant facts are present in `Shared User Facts`, answer directly from those facts in one sentence.
